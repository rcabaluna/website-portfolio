...
const About = () => {
  return (
    <section className="about w-full md:min-h-screen px-40 flex flex-col md:justify-center">
      {/* Row 1: Develop */}
      <div className="flex flex-col md:flex-row items-center md:gap-12 md:mb-20 lg:mb-0 develop-row">
        ...
        <div className="hidden md:flex flex-1 justify-center items-center top-svg">
      ...
      {/* Row 2: Support */}
      <div className="flex flex-col md:flex-row items-center md:gap-12 md:mb-20 support-row">
        <div className="hidden md:flex flex-1 justify-center items-center bottom-svg">
