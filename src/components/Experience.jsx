...
const Experience = () => {
    ...
    return (
        <section
            ref={ref}
            className="experience w-full md:min-h-screen bg-[#4831D4] md:px-40 flex md:items-center relative overflow-hidden"
        >
            <div className="flex flex-col md:flex-row items-center md:gap-12 relative z-10 w-full row-container">
                {/* Left Column - Text */}
                ...
                {/* Right Column - Image */}
                <motion.div
                    className="md:flex basis-[55%] w-full relative"
                    variants={imageVariant}
                    initial="hidden"
                    animate={isInView ? "visible" : "hidden"}
                >
                    <div className="w-[500px] h-[500px] bg-[#CCF381] rounded-full shadow-sm flex justify-center transform scale-125 working-image">
                        <img
                            src={workingGIF}
