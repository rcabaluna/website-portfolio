...
const About = () => {
  return (
    <section className="about w-full min-h-screen px-12 md:px-60 py-20 flex flex-col justify-center">
      <div className="space-y-20">

        {/* Row 1: Develop */}
        <div className="flex flex-col md:flex-row items-center md:gap-52">
